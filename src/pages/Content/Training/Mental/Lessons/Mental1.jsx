    ...
    <LessonContainer>
      ...
      <CarouselContainer>
        ...
        <Slide active={currentSlide === 1}>
          ...
          <Text>
            O enriquecimento ambiental mantém o cão entretido, reduz o tédio e ajuda a evitar comportamentos destrutivos.
          </Text>
        </Slide>
        ...
        <Slide active={currentSlide === 2}>
          ...
          <StepList>
            <StepItem>Escolha brinquedos interativos: Mordedores recheáveis, brinquedos que liberam petiscos e quebra-cabeças para cães são ótimos para estimulação mental.</StepItem>
            <StepItem>Varie os brinquedos: Alterne os brinquedos para evitar que o cão perca o interesse.</StepItem>
            <StepItem>Crie desafios: Esconda petiscos pela casa e incentive o cão a encontrá-los.</StepItem>
            <StepItem>Estimule diferentes sentidos: Use brinquedos de texturas variadas, sons e cheiros para manter o cão engajado.</StepItem>
            <StepItem>Dê novos desafios semanalmente: Mudar a posição da caminha, trocar os brinquedos e criar novos jogos ajudam o cão a se adaptar e aprender.</StepItem>
          </StepList>
        </Slide>
