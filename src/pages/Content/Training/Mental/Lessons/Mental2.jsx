    ...
    <LessonContainer>
      ...
      <CarouselContainer>
        ...
        <Slide active={currentSlide === 1}>
          ...
          <Text>
            Em dias chuvosos ou quando o tutor não pode sair para passeios longos, jogos dentro de casa ajudam a manter o cão estimulado.
          </Text>
        </Slide>
        ...
        <Slide active={currentSlide === 2}>
          ...
          <StepList>
            <StepItem>Cabo de guerra: Use uma corda resistente para brincar, incentivando o cão a puxar (sempre controlando a intensidade).</StepItem>
            <StepItem>Esconde-esconde: Peça para o cão esperar, esconda-se e chame-o para te encontrar. Isso estimula o faro e a obediência.</StepItem>
            <StepItem>Corrida de obstáculos caseira: Use almofadas, cadeiras e caixas para criar um pequeno percurso dentro de casa.</StepItem>
            <StepItem>Busca de petiscos: Espalhe petiscos pela casa e incentive o cão a farejá-los.</StepItem>
            <StepItem>Comandos intercalados: Peça ao cão para sentar, deitar, dar a pata e recompense com petiscos.</StepItem>
          </StepList>
        </Slide>
