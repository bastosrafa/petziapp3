...
import Mental3Image from '@/assets/images/training/Mental3.png';
...
export default function Mental3({ onNextLesson }) {
  ...
  const nextSlide = async () => {
    if (currentSlide === 3) {
      ...
      localStorage.setItem("mental3_completed", "true");
      localStorage.setItem("mental4_unlocked", "true");
      ...
      try {
        if (user) {
          ...
          Promise.race([
            ...
            console.log("Progresso da lição Mental3 salvo com sucesso");
          }).catch(error => {
  ...
  return (
    <LessonContainer>
      <Title>
        Truques Simples para Ensinar ao Cão
        {localStorage.getItem("mental3_completed") === "true" && (
      ...
      <CarouselContainer>
        ...
        <Slide active={currentSlide === 0}>
          <SlideContent>
            ...
            <ImageContainer>
              <StyledImage src={Mental3Image} alt="Imagem ilustrativa de cão realizando truques" />
            </ImageContainer>
            <IntroductionText>
              Nesta aula, vamos aprender truques simples e divertidos que você pode ensinar ao seu cão para estimular seu desenvolvimento mental.
            </IntroductionText>
          </SlideContent>
        </Slide>
        ...
        <Slide active={currentSlide === 3}>
          <SlideContent>
            ...
            <SummaryList>
              <SummaryItem>Use petiscos como recompensa para motivar o aprendizado.</SummaryItem>
              <SummaryItem>Mantenha as sessões de treino curtas e divertidas.</SummaryItem>
              <SummaryItem>Celebre cada pequeno progresso do seu cão.</SummaryItem>
            </SummaryList>
          </SlideContent>
        </Slide>
