    ...
    <LessonContainer>
      ...
      <CarouselContainer>
        ...
        <Slide active={currentSlide === 1}>
          <SlideTitle>Por que praticar?</SlideTitle>
          <Text>
            Os esportes caninos são excelentes para manter seu cão física e mentalmente saudável, além de fortalecer ainda mais o vínculo entre vocês através de atividades divertidas e desafiadoras.
          </Text>
        </Slide>

        {/* Slide 2: Passo a Passo */}
        <Slide active={currentSlide === 2}>
          <SlideTitle>Principais Esportes</SlideTitle>
          <StepList>
            <StepItem>Agility: Percurso com obstáculos onde o cão deve seguir as orientações do tutor.</StepItem>
            <StepItem>Canicross: Corrida com o cão preso à cintura do tutor por um equipamento específico.</StepItem>
            <StepItem>Disc Dog: Brincadeiras com frisbee, incluindo saltos e pegadas no ar.</StepItem>
            <StepItem>Dock Diving: Saltos na água para pegar objetos ou alcançar distância.</StepItem>
            <StepItem>Rally Obedience: Percurso com estações de exercícios de obediência.</StepItem>
          </StepList>
        </Slide>
